...
normality.tests <- function(x) {
  c(Pearson = pearson.test(x)$p,
    Lilliefors =lillie.test(x)$p,
    Anderson.Darling = ad.test(x)$p,
    Shapiro.Wilk = shapiro.test(x)$p)
}
...
|:-------:|:------------:|:-----------:|:-------:|:------------:|
| p-value |    0.07419   |    0.4219   |  0.3014 |    0.2459    |
...
|         | Pearson | Lilliefors | Anderson-Darling | Shapiro-Wilk |
|:-------:|:------------:|:-----------:|:-------:|:------------:|
| p-value |    0.3685    |    0.7872   |  0.9112 |    0.9922    |
...
|         | Pearson | Lilliefors |  Anderson-Darling | Shapiro-Wilk |
|:-------:|:------------:|:-----------:|:--------:|:------------:|
| p-value |   0.008887   |  0.0004679  | 0.004763 |    0.00526   |
...
|          |  Fisher | Welch Two Sample t-test |
|:--------:|:-------:|:-----------------------:|
| BODY_WEI |  0.4445 |          0.2866         |
|   SLEEP  | 0.01559 |         0.004973        |
...
|:--------:|:-----------------:|:-----------------------:|
| BODY_WEI |     3.022e-07     |        2.368e-07        |
|   SLEEP  |     6.464e-08     |        8.383e-11        |
...
но все же используем критерий Уолкоксона ради академического интереса.
```{r, warning=FALSE, message = FALSE}
...
корреляции индексов и сна. То есть чем в большей опасности находится животное, 
...
Это будет иметь смысл, так как между индексами и весом/сном коэффициент Пирсона 
значим, то есть есть линейная зависимость между индексами и весом/сном, которая
