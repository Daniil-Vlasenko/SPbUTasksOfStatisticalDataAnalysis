...
Первый критерий исользуется не поназначению (так как дисперсии разные), второй
...
но все же используем критерий Уолкоксона, так как он является точным критерием.
