...
```
Можно заметить, что животные живущие в более защищенных местах имеют меньший
...
Проверим это с помощью критериев, но для этого сначала поймем, какое распределение
имеют признаки.
