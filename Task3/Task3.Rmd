...
((dplyr::select(dfSlowwave, -NAME, -BRAIN_WE, -LIFESPAN, -GESTTIME) %>%
mutate(PRED_IND = as.numeric(PRED_IND), EXP_IND = as.numeric(EXP_IND), DANG_IND = as.numeric(DANG_IND)) %>%
pcor(method = "spearman"))$estimate %>%
as.data.frame())["SLOWWAVE", "BODY_WEI"]

((dplyr::select(dfParadox, -NAME, -BRAIN_WE, -LIFESPAN, -GESTTIME) %>%
mutate(PRED_IND = as.numeric(PRED_IND), EXP_IND = as.numeric(EXP_IND), DANG_IND = as.numeric(DANG_IND)) %>%
pcor(method = "spearman"))$estimate %>%
...
```{r, warning=FALSE, message = FALSE}
((dplyr::select(dfSlowwave, -NAME, -EXP_IND, -DANG_IND) %>%
mutate(PRED_IND = as.numeric(PRED_IND)) %>%
pcor(method = "spearman"))$estimate %>% 
as.data.frame())["SLOWWAVE", "PRED_IND"]

((dplyr::select(dfSlowwave, -NAME, -PRED_IND, -DANG_IND) %>%
mutate(EXP_IND = as.numeric(EXP_IND)) %>%
pcor(method = "spearman"))$estimate %>% 
as.data.frame())["SLOWWAVE", "EXP_IND"]

((dplyr::select(dfSlowwave, -NAME, -EXP_IND, -PRED_IND) %>%
mutate(DANG_IND = as.numeric(DANG_IND)) %>%
pcor(method = "spearman"))$estimate %>% 
...
```{r, warning=FALSE, message = FALSE}
((dplyr::select(dfParadox, -NAME, -EXP_IND, -DANG_IND) %>%
mutate(PRED_IND = as.numeric(PRED_IND)) %>%
pcor(method = "spearman"))$estimate %>% 
as.data.frame())["PARADOX", "PRED_IND"]

((dplyr::select(dfParadox, -NAME, -PRED_IND, -DANG_IND) %>%
mutate(EXP_IND = as.numeric(EXP_IND)) %>%
pcor(method = "spearman"))$estimate %>% 
as.data.frame())["PARADOX", "EXP_IND"]

((dplyr::select(dfParadox, -NAME, -EXP_IND, -PRED_IND) %>%
mutate(DANG_IND = as.numeric(DANG_IND)) %>%
pcor(method = "spearman"))$estimate %>% 
